...
\date{\textbf{09 de agosto de 2018} }
...
\begin{document}
	...
	\begin{frame}{Informações Importantes}
		\begin{block}{Disciplina}
			\begin{itemize}
				...
				\item 07h30-09h10 (Quinta, [CA2, Sala 07])\\
				07h30-09h10 (Sexta, [CA2, Sala 07])
				\item Dúvidas: 09h30 - 11h10 (Quinta)\\
				{\color{red}[é necessário confirmação comigo]}
				\item Grupo: \url{facebook.com/groups/lfa.ufj.2018.2/}
	...
	\begin{frame}{Avaliação}
		\begin{block}{Média Final}
			...
			\begin{center}
				PONT = $\left[ \sum\limits_{i=1}^{4} \mbox{max}(MT_i, SMT_i) + PF \right] \times 0,2 + QC$
			\end{center}
		\end{block} \pause
	...
	\begin{frame}{Estudo Prévio}
		\begin{block}{Leitura 01}
			Capítulo 0: Seção 0.1 e 0.2.
		\end{block}
		\begin{block}{Livro}
